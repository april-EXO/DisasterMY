				...
				<div class="d-grid gap-2 p-5 mx-auto text-center">
					<div class="card" style="background-color: rgba(212, 197, 185, 0.2);color:white">
						<div class="card-body p-3">
							...
							<ul>
								<br><br>
								<li><input type="button" class="btn btn-outline-info btn-rounded" data-mdb-ripple-color="dark" onclick="stop(); showFrame(animationPosition - 1); return;" value="&lt;" /></li>
								<li><input type="button" class="btn btn-outline-info btn-rounded" data-mdb-ripple-color="dark" onclick="playStop();" value="Play / Stop" /></li>
								<li><input type="button" class="btn btn-outline-info btn-rounded" data-mdb-ripple-color="dark" onclick="stop(); showFrame(animationPosition + 1); return;" value="&gt;" /></li>
								<br><br>
								<li>
									<div class="form-floating"><select id="colors" class="form-select" onchange="setColors(); return;">
